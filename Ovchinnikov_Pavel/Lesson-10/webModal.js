// Класс отвечает модального окна в браузер
...
class WebModal {
    ...
    // обработка нажатия на миниатюры картинок
    ...
    // обработка нажатия на кнопку button_prev
    button_prev_onclick() {
        this.GetPreviousImg();
        this.SetCurrentImg();
        this.SetCurrentImgMini();
    ...
    // обработка нажатия на кнопку button_next
    button_next_onclick() {
        this.GetNextImg();
        this.SetCurrentImg();
        this.SetCurrentImgMini();
