...
class MessengerContainerClass extends Component {
    ...
    render() {
        ...
        return <Messenger messages={messages} handleMessageSend={this.handleMessageSend} handleChatAdd={this.handleChatAdd} handleChatDelete={this.handleChatDelete} handleChatFire={this.handleChatFire} handleChatUnfire={this.handleChatUnfire} />
    }
}
