...
app.post('/todo', async (req, res) => {
    ...
    const tasks = new tasksModel({user: _id, name: name, items: [{name: "Смотреть вебинар"}, {name: "Сделать ДЗ"}]})
...
app.post('/register', async (req, res) => {
    ...
    const emailUser = await usersModel.findOne({email: restBody.email})
    if (emailUser) {
