...
//Все сделано по заданию7.1-7.5 
//не совсем понял на счет сворачивания блоков, так что сделал как понял: просто вывожу внутреннюю часть блока в зависимости от этапа формирования заказа.
